...
image::common:roadshow-app-architecture-parksmap-1.png[Application architecture,800,align="center"]
...
image::common:parksmap-devconsole-container-image.png[Add from Container Image]
...
image::common:parksmap-image.png[Explore Project]
...
image::common:nationalparks-labels.png[Labels image]
...
image::common:parksmap-image-options.png[Deploy image]
...
image::common:parksmap-dc-topology.png[Topology View with Parksmap]
...
image::common:switchtoresources.png[Details Tab image]

On that panel, you will see that there is a single *Pod* that was created by your actions.

image::common:parksmap-overview.png[Pod overview]
...
image::common:parksmap-podlist.png[Pod list]
...
image::common:parksmap-dc-resources.png[Parksmap Resources]
...
image::common:parksmap-pod.png[Pod Details]

image::common:parksmap-pod-events.png[Pod Events]
...
image::common:nationalparks-listview.png[List View Toggle]

image::common:nationalparks-graphview.png[Topology View Toggle]
...
image::common:parksmap-serviceslist.png[Services list]
...
image::common:parksmap-service.png[Service]
